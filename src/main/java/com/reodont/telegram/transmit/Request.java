...
import com.reodont.telegram.model.com.reodont.telegram.model.object.*;
...
public class Request {
    ...
    public UserProfilePhotos getUserProfilePhotos(User user) throws IOException {
        ...
        return (UserProfilePhotos) new Gson().fromJson(content, UserProfilePhotos.class);
    }

    public com.reodont.telegram.model.com.reodont.telegram.model.object.File getFile(String fileId, String filePath) throws IOException {
        String content = makeRequest("https://api.telegram.org/file/bot" + token + "/" + filePath, "?file_id=" + fileId);

        return (com.reodont.telegram.model.com.reodont.telegram.model.object.File) new Gson().fromJson(content, com.reodont.telegram.model.com.reodont.telegram.model.object.File.class);
    }
    ...
    public void setChatPhoto(Chat chat, com.reodont.telegram.model.com.reodont.telegram.model.object.File file) throws IOException {
    ...
    public Chat getChat(Integer chatId) throws IOException {
        ...
        return (Chat) new Gson().fromJson(content, Chat.class);
    }
    ...
    public Integer getChatMembersCount(Chat chat) throws IOException {
        ...
        return (Integer) new Gson().fromJson(content, Integer.class);
    }
    ...
    public ChatMember getChatMember(Chat chat, User user) throws IOException {
        ...
        return (ChatMember) new Gson().fromJson(content, ChatMember.class);
    }
